            ...
            <Wrap spacing={{ base: 20, sm: 3, md: 5, lg: 20 }}>
              <WrapItem>
                <Box>
                  ...
                  >
                    <a
                      href="https://www.linkedin.com/in/vinaykumar-hatwar-a508831a1/"
                      target="_blank"
                    >
                      <IconButton
                        aria-label="linkedin"
                    ...
                    <a href="https://github.com/vinaykumar7580" target="_blank">
                      <IconButton
                        aria-label="github"
                        variant="ghost"
                        size="lg"
                  ...
                  <Box m={8} color="#0B0E3F">
                    <VStack spacing={5} textAlign="left">
                      <form ref={form} onSubmit={sendEmail}>
                        ...
                        <br />
                        <br />
                        <button type="submit" className={style.emailButtons}>
                          Send Message
                        </button>
                      </form>
                    </VStack>
